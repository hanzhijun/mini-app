...
Page({
    ...
    openPage: function (e) {
        ...
        let {order_id, business_id, ordertype} = this.data;
        ...
        if (index == 1) {
            ...
            app.openPage(`mine/allOrder/finishDetail/finishDetail?order_id=${order_id}&business_id=${business_id}&ordertype=${ordertype}`, 'close')
        }
