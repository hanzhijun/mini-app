...
Page({
    ...
    getOrder(options) {
        ...
        app.post('Order/confirmOrder_new', ginfo, (res) => {
            if (res.code == 200) {
                let {defaultreceiver, is_can_buy, result, user_account} = res.data;
                ...
                var s_price;
                s_price = total.price / 100 - user_account.surplus_goldshells < 0 ? 0 : (total.price - user_account.surplus_goldshells * 100) / 100;
                s_price = s_price * 100;
    ...
    checkSwitch: function (e) {
        ...
        let {total, total_price} = this.data;
        let {price} = total;
    ...
    openPageAddress: function () {
        ...
        app.openPage('mine/adress/adress?history_page=order')
